...
<body class="wrapper flex">
    ...
    <header class="flex reveal">
        ...
        <div id="project" class="reveal-1">
            ...
            <p>
                <strong>Passionné de sport</strong> et fort d'une <strong>solide expérience commerciale</strong> (B2B/B2C), je souhaite réintégrer le secteur de la <strong>distribution spécialisée</strong>. 
                <strong>Ancien collaborateur Intersport</strong>, je maîtrise les <strong>techniques de vente</strong>, la <strong>gestion des stocks</strong> et le <strong>conseil client</strong>.
            </p>

            <p>
                <strong>Polyvalent, rigoureux</strong> et <strong>sportif régulier</strong>, je suis prêt à mettre mon <strong>dynamisme</strong> et mon <strong>sens du défi</strong> au service de votre équipe.
            </p>
        </div>
    </header>
